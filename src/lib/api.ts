...
export const api = {
  ...
  confirmMarketplaceOrderPackage: (id: string, data: any) => fetchAPI(`/marketplace/orders/${encodeURIComponent(id)}/package`, { method: 'POST', body: JSON.stringify(data) }),
  requestMarketplacePayout: (id: string) => fetchAPI(`/marketplace/orders/${encodeURIComponent(id)}/payout-request`, { method: 'POST' }),
  getMarketplacePayouts: () => fetchAPI('/marketplace/seller/payouts'),
