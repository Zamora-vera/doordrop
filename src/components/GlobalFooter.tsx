...
export const GlobalFooter: React.FC = () => {
  ...
  const footerText = {
    ...
    it: {
      ...
      marketplaceProducts: 'Tutti i Prodotti', marketplaceShipping: 'Con Spedizione DoorDrop', marketplaceSeller: 'Hub del Venditore', marketplaceMessages: 'Messaggi & Trattative', account: 'Mio Account', dashboard: 'Dashboard Cliente', wallet: 'Portafoglio & Ricarica', support: 'Assistenza & Ticket', register: 'Registrati Gratis', terms: 'Termini di Servizio', privacy: 'Informativa Privacy', rights: 'Tutti i diritti riservati.'
    },
    en: {
