...
const entries: Array<{ sources: string[]; t: Record<Lang, string> }> = [
  ...
  // SHIP24GO_QUOTE_I18N_RUNTIME_V1
  {
    sources: ['Buscando las mejores tarifas...', 'Finding the best rates...', 'Cerchiamo le migliori tariffe...'],
    t: { es: 'Buscando las mejores tarifas...', en: 'Finding the best rates...', it: 'Cerchiamo le migliori tariffe...', fr: 'Recherche des meilleurs tarifs...', de: 'Beste Tarife werden gesucht...', zh: '正在查找最优价格...' }
  },
  {
    sources: ['Comparando precios y plazos...', 'Comparing prices and transit times...', 'Confronto prezzi e tempi di consegna...'],
    t: { es: 'Comparando precios y plazos...', en: 'Comparing prices and transit times...', it: 'Confronto prezzi e tempi di consegna...', fr: 'Comparaison des prix et delais...', de: 'Preise und Laufzeiten werden verglichen...', zh: '正在比较价格与时效...' }
  },
  {
    sources: ['Enviar a preparacion', 'Enviar a preparación', 'Send to preparation', 'Invia in preparazione'],
    t: { es: 'Enviar a preparacion', en: 'Send to preparation', it: 'Invia in preparazione', fr: 'Envoyer en preparation', de: 'Zur Vorbereitung senden', zh: '发送到准备中' }
  },
  ...
  {
    sources: ['Copilote IA (SQL)', 'Copiloto AI', 'AI Copilot', 'Copilota AI (SQL)', 'KI-Copilot', 'AI 助手'],
